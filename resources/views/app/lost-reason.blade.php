    ...
    <div class="content-page">
        <div class="content">
            ...
            <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <a href="javascript:void(0);" class="btn btn-primary btn-sm mb-2"
                                   onclick="openModal('#lost-reason-modal','Create Lost Reason','#lost-reason-form','.modal-title',id=0)"><i
                            ...
                            <div class="page-title-left pt-2">
                                {{--<h4 class="page-title">Lost Reason</h4>--}}
                                <select class="form-select" id="fil_status" name="fil_status" style="width: 190px;background-color: #fff0 !important;border: 0px solid #fff !important;font-size: 14px;margin: 0;white-space: nowrap;font-weight: 700;padding: 0.0rem 0.0rem 0rem 0.5rem;">
                                    <option value="">All Lost Reason</option>
                                    <option value="0">Active Lost Reason</option>
                                    <option value="1">Deactive Lost Reason</option>
                                </select>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <table id="lost-reason-datatable" class="table table-centered table-sm w-100 nowrap">
            ...
            {{--                            <th>Description</th>--}}
                ...
                <!-- end row-->
                <div id="lost-reason-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-right" style="width: 100%;">
            <div class="modal-content" style="height: 100%;">
                <div class="modal-header border-1 bg-light">
                    <h4 class="modal-title">Create Lost Reason</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form class="ps-3 pe-3 lost-reason-form" id="lost-reason-form" action="#">

                        <input class="form-control" type="hidden" id="id" name="id" value="0">
                        <div class="form-floating mb-2">
                            <input class="form-control bg-light text-dark" type="text" id="name" name="name" required="" placeholder="Enter name" autofocus>
                        ...
                        <div class="text-end">
                            ...
                            <button class="btn btn-primary btn-sm" id="lost_reason_button" type="submit"><i
...
@push('scripts')
    ...
    <script>
        $(document).ready(function () {
            ...
            "use strict";
            var table = $("#lost-reason-datatable").DataTable({
                // dom: 'Bfrtip',
                dom:
...
{{--                                @endif--}}
            ...
            table.buttons().container().appendTo("#lost-reason-datatable_wrapper .col-md-6:eq(0)"), $("#alternative-page-datatable").DataTable({
            ...
            formValition('#lost-reason-form');
            $('.lost-reason-form').on('submit', function (e) {
                e.preventDefault();
                if ($(this).parsley().isValid()) {
                    $.ajax({
                        ...
                        dataType: "json",
                        beforeSend: function () {
                            $("#lost_reason_button").prop('disabled', true);
                            $("#lost_reason_button").html('<i class="mdi mdi-spin mdi-loading"></i> Loading...');
                        },
                        success: function (data) {
                            toastrSuccess('Successfully saved...', 'Success');
                            $('#lost-reason-modal').modal('toggle');
                            table.ajax.reload();
                            $("#lost_reason_button").prop('disabled', false);
                            $("#lost_reason_button").html('<i class="uil-arrow-circle-right"></i> Save');
                        },
                        ...
                        complete: function (data) {
                            $("#lost_reason_button").html('Save');
                            $("#lost_reason_button").prop('<i class="uil-arrow-circle-right"></i> disabled', false);
                        }
                    });
                }
            });
        ...
        function edit_id(id) {
            $.ajax({
                ...
                success: function (res) {
                    resetFormValidation("#lost-reason-form");
                    $('#id').val(res.data.id);
                    $('#name').val(res.data.name);
                    // $('#description').val(res.data.description);
                    $('.modal-title').text('Edit Lost Reason');
                    $('#lost-reason-modal').modal('toggle');
                }
            });
        }
