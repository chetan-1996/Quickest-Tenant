                            ...
                            <div class="card d-block">
                                ...
                                {{-- <div class="dropdown card-widgets">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end" style="">
                                            <!-- item-->
                                            <a href="{{route('tenant.proposal.new-create', [ 'tenant' => $segment, 'id' => $value->id])}}" class="dropdown-item"><i
                                                    class="mdi mdi-pencil me-1"></i>Edit</a>
                                            <!-- item-->
                                            <!-- item-->
                                            <a href="{{route('tenant.proposal.pdf-preview', [ 'tenant' => $segment])}}" class="dropdown-item" target="_blank"><i class="uil uil-web-grid-alt"></i> Preview</a>
                                            <!-- item-->
                                        </div>
                                    </div>--}}
                                    <!-- project title-->
                                    <h4 class="mt-0">
                                        @if(in_array('template-setting', $user_perm))
                                                <a href="{{route('tenant.proposal.new-create', [ 'tenant' => $segment, 'id' => $value->id])}}" class="text-title">{{ $value->template_name }}</a>
                                        @else
                                    ...
                                    <div class="text-center">
                                        @if(in_array('template-setting', $user_perm))
                                            <a href="{{route('tenant.proposal.new-create', [ 'tenant' => $segment, 'id' => $value->id])}}" class="btn btn-sm px-1 btn btn-dark mt-2"><i class="mdi mdi-pencil"></i> Edit</a>
                                        @else
                                        ...
                                        <a href="{{route('tenant.proposal.pdf-preview', [ 'tenant' => $segment])}}" target="_blank" class="btn btn-sm px-1 btn btn-light ms-2 mt-2"><i class="uil uil-web-grid-alt"></i> Preview</a>
                                    </div>
                                    <!-- project detail-->
                                </div> <!-- end card-body-->
                            </div> <!-- end card-->
