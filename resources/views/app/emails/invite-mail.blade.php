                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0"
                                            ...
                                            <tbody>
                                                ...
                                                <tr
                                                    style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                                    <td class="content-block"
                                                        style="font-family: 'Roboto', sans-serif; color: #878a99; box-sizing: border-box; font-size: 15px; vertical-align: top; margin: 0; padding: 0 0 10px;"
                                                        valign="top">
                                                        <p> You are invited by  {{ $mail_details['invite_user_name'] }} to Join the Quickest. </p>
{{--                                                        <p>Below are your login credentials,</p>--}}
                                                ...
                                                <tr
                                                    style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                                    <td class="content-block"
                                                        style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 10px;text-align: center;padding-top: 15px;text-align:left;"
                                                        valign="top">
                                                        <a href="{{ url($mail_details['domain'].'/verify-invite-account/' . $mail_details['id']) }}"
                                                            ...
                                                            onmouseout="this.style.background='#4b38b3'">Accept Invitation</a>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr
                                                    ...
                                                    <td class="content-block"
                                                        style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0; padding-top: 10px"
                                                        valign="top">
                                                 ...
                                                 style="border-radius: 50px;"> --}}
                                                            <div style="margin-left: 8px;">
                                                                <span>Thank You.</span>
                                                                <p
                                                                    style="font-size: 14px; margin-bottom: 0px; margin-top: 10px;">
                                                                    Team Quickest</p>
                                                            </div>
                                                        </div>
                                                    </td>
