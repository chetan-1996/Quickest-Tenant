                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('tenant.term-condition.index', ['tenant' => $segment])}}">Term & Condition</a></li>
                                <li class="breadcrumb-item active">Edit</li>
                            </ol>

                        </div>
                        <h4 class="page-title">Edit Term & Condition</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                            ...
                            <form class="ps-3 pe-3 term-condition-form" id="term-condition-form" action="#">
                                ...
                                <div class="mb-1">
                                    ...
                                    <input class="form-control" type="text" id="name" name="name" required=""
                                        placeholder="Enter name" autofocus value="{{$terms_conditions->name}}">
                                    <input class="form-control" type="hidden" id="id" name="id" value="{{$terms_conditions->id}}">
                                </div>

                                <div class="mb-3">
                                    <label for="description" class="form-label">Description <span class="text-danger">*</span></label>
                                    <textarea class="form-control" id="description" name="description"
                                            placeholder="Enter description">{!!html_entity_decode($terms_conditions->description, ENT_QUOTES, 'UTF-8')!!}</textarea>
                                </div>
