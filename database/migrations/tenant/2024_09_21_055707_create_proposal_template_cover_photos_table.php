...
return new class extends Migration
{
    ...
    {
        Schema::create('proposal_template_cover_photos', function (Blueprint $table) {
            $table->id();
            $table->string('image_icon')->nullable();
            $table->boolean('proposal_template_id')->unsignedBigInteger()->default(0);
            $table->boolean('cover_flg')->default(false);
    ...
    {
        Schema::dropIfExists('proposal_template_cover_photos');
    }
};
