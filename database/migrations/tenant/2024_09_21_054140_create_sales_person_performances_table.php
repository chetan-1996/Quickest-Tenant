...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('sales_person_performances', function (Blueprint $table) {
            ...
            $table->integer('adv_completed_task')->default(0);
            $table->double('daily_performance', 10, 2)->default(0);
            $table->bigInteger('company_id')->unsignedBigInteger()->default(0);
            $table->integer('timeline_id')->unsignedBigInteger()->default(0);
            $table->integer('customer_id')->unsignedBigInteger()->default(0);
            $table->timestamps();
        });
    }
