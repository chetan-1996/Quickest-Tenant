...
return new class extends Migration
{
    ...
    {
        Schema::create('content_file_timelines', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('file_id')->unsignedBigInteger()->default(0);
    ...
    {
        Schema::dropIfExists('content_file_timelines');
    }
};
